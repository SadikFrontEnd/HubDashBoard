...
// Hub
const AssignToHub = lazy(() =>
  import("./views/apps/freshlist/hub/AssignToHub")
);
const AssignToBatch = lazy(() =>
  import("./views/apps/freshlist/hub/AssignToBatch")
);
const AddProduct = lazy(() => import("./views/apps/freshlist/hub/AddProduct"));
const CreateBatch = lazy(() =>
  import("./views/apps/freshlist/hub/CreateBatch")
);

const AddBatch = lazy(() => import("./views/apps/freshlist/hub/AddBatch"));
const AddBrand = lazy(() => import("./views/apps/freshlist/hub/AddBrand"));
...
const LanguagesList = lazy(() =>
  import("./views/apps/freshlist/language/LanguagesList")
);
...
const AddDeliveryMan = lazy(() =>
  import("./views/apps/freshlist/delivery/AddDeliveryMan")
);
const DeliveryManList = lazy(() =>
  import("./views/apps/freshlist/delivery/DeliveryManList")
);
const EditDeliveryMan = lazy(() =>
  import("./views/apps/freshlist/delivery/EditDeliveryMan")
);
//Coupon
...
const Packaging = lazy(() => import("./views/apps/freshlist/order/Packaging"));
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          {/* Hub  start*/}
          <AppRoute
            path="/app/freshlist/hub/assigntoHub"
            component={AssignToHub}
          />
          <AppRoute
            path="/app/freshlist/hub/addproduct"
            component={AddProduct}
          />
          <AppRoute
            path="/app/freshlist/hub/assigntoBatch"
            component={AssignToBatch}
          />
          <AppRoute
            path="/app/freshlist/hub/createbatch"
            component={CreateBatch}
          />
          <AppRoute path="/app/freshlist/hub/addbatch" component={AddBatch} />
          <AppRoute path="/app/freshlist/hub/addbrand" component={AddBrand} />
          {/* Hub  End*/}
          <AppRoute
          ...
          {/* Language */}
          <AppRoute
            path="/app/freshlist/language/languagesList"
          ...
          {/* Delivery */}
          <AppRoute
            path="/app/freshlist/delivery/addDeliveryMan"
            component={AddDeliveryMan}
          />
          <AppRoute
            path="/app/freshlist/delivery/deliveryManList"
